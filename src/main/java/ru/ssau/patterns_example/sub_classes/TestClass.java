...
import ru.ssau.patterns_example.factory.AutoFactory;
import ru.ssau.patterns_example.factory.TransportFactory;
...
public class TestClass {
    ...
    //приватное статическое поле factory типа TransportFactory
    private static TransportFactory factory = new AutoFactory();

    // и соответствующий ему публичный метод setTransportFactory(),
    public static void setTransportFactory(TransportFactory tf) {
        factory = tf;
    }
